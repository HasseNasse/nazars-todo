...
public class JwtVerifier {
    ...
    private static final String libertyHostname = System.getProperty("app.hostname");
    ...
    public String createJwt(String username, Set<String> groups) throws GeneralSecurityException, IOException {
        ...
        JsonObject claimsObj = Json.createObjectBuilder()
                ...
                .add("aud", "todoApiConsumer")                           // Audience
    ...
    private PublicKey getPublicKey() throws Base64Exception, InvalidKeySpecException, NoSuchAlgorithmException {
        ...
        assertEquals("HTTP response code should have been " + Response.Status.OK.getStatusCode() + ".",
